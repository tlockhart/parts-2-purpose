// Instruction: Open bash and run the following command
// from the apps scripts directory
// command: node seedDB.js
...
function main(){
  ...
  populateOrder = () => {
    db.Order.find({"_id": orderId})
          ...
          // orders with any associated users and products
          .populate("user")
